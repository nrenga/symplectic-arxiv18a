...
Omega = [Z, I; I, Z];     % Transversal Hadamards
Elem1 = @(Q) (blkdiag(Q, g2matinv(Q)'));  % CNOTs, Permutations
Elem2 = @(P) ([I, P; Z, I]);    % CZs, Phase gates
...
if (k == m)
    ...
    P = Fcp(m+(1:m), 1:m);
    Decomp = {g2matinv(Qleft1); Omega; Elem2(P); Omega; g2matinv(Pright); g2matinv(Qright)};
    return;
end
...
Decomp = {g2matinv(Q); Omega; Elem2(P); Elem3(k); g2matinv(Pright); g2matinv(Qright)}; 
